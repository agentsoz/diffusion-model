...
public class TestCLTModel {
    ...
    public void testSNConifgs() {
        ...
        assertEquals("clt", SNConfig.getDiffusionModelsList().get(0)); // #FIXME
        ...
        assertEquals(SNConfig.getOutputFilePathOFLTModel(),"./test/output/diffusion_clt.out");
    ...
    public void testcompetivitveDiffusion() {
        ...
        testCLT.assignFixedThresholds(DataTypes.WAIT, 0.25, 0.25); //set thresholds
        testCLT.assignFixedThresholds(DataTypes.PANIC, 0.25, 0.25); //set thresholds
